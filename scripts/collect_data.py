...
def parse_args():
    ...
    parser.add_argument("--instruction", type=str, default="pick up the object and place it in the goal",
...
def main():
    ...
    print("Saved Meta-World pick-place dataset to", args.output_path)
