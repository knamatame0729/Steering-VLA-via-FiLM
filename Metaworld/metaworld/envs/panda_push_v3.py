...
class PandaPushEnvV3(PandaXYZEnv):
    """Push environment using Franka Panda robot."""
    ...
    def model_name(self) -> str:
        return full_panda_path_for("panda_xyz/panda_push_v3.xml")
